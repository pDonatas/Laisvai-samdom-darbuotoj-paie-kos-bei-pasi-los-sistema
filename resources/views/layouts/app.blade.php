        ...
        <div class="d-table-cell">
            <div class="container">
                <div class="banner-content">
                    ...
                    <h1>{{__('page.intro_heading')}}</h1>
                    <p>{{__('page.intro_subtitle')}}</p>
                    <div class="btn-box">
                        <a href="https://www.youtube.com/watch?v=cuyS5NhzOWY" class="video-btn popup-youtube"><span><i class='bx bx-play-circle'></i></span> {{__('page.watch')}}</a>
                    </div>
                </div>
            </div>
        </div>
